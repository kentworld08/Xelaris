...
export default function LoginPage() {
  ...
  return (
    <main className="md:h-[864px] md:bg-black24 flex justify-center items-center flex-col px-[20px] md:px-[72px] bg-[#FBFAF4] h-[864px]">
      <h1 className="font-sans font-normal text-[30px] leading-[23px] tracking-[0.23px] mb-[28px] text-black24">
        Welcome back
      </h1>
      <form
      ...
      >
        ...
        <button
          ...
          className="md:px-[21px] md:py-[9px] rounded-[9999px] bg-yellow69 text-black24 font-sans font-medium hover:opacity-90 md:w-[418px] md:h-[50px] w-full px-[13px] py-[9px] text-[17px] mt-[59.49px]"
        >
