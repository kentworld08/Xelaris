...
// import React from "react";
// import { useFormContext } from "react-hook-form";
// import { FullFormValues } from "../Schema/FormSchemas";
...
//         <label
//           htmlFor="parentName"
//           className="block md:text-[15.63px] font-medium text-black24 font-sans md:leading-[22px]"
//         >
//           Parent Full Name
//         </label>
//         <input
...
//           placeholder="Alexa Plex"
//           {...register("parentName")}
//           className="mt-1 block w-full border-[#D9DCE1] shadow-sm p-2 border-[1px] rounded-[4px]"
//         />
//         {errors.parentName && (
//           <p className="mt-1 text-sm text-red-600">
//             {errors.parentName.message}
